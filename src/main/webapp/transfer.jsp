...
<head>
    <meta charset="UTF-8">
    <title>FlowBank – Переказ коштів</title>
...
<main>
    <div class="form-container">
        ...
        <form method="post" action="transfer">
            <input type="text" name="senderAccount" placeholder="Sender Account Number" style="font-family: 'Cormorant Upright'; font-size: 20px;" required>
            <input type="text" name="receiverAccount" placeholder="Receiver Account Number" style="font-family: 'Cormorant Upright'; font-size: 20px;" required>
            ...
            <button class="button" type="submit" style="font-family: 'Cormorant Upright'; font-size: 28px;">Confirm</button>
        </form>
