...
<head>
  ...
  <title>FlowBank Admin Login</title>
...
<form class="client-container" method="post" action="admin-login">

  <!-- 🔝 Перемикач ролей -->
  <div class="role-selector">
    <button type="button" class="role-button" style="font-family: 'Cormorant Upright'; font-size: 28px; color: rgba(56, 39, 18, 1) ;" onclick="location.href='signin_client.jsp'">Client</button>
    <button type="button" class="role-button" style="font-family: 'Cormorant Upright'; font-size: 28px;" disabled>Admin</button>
  </div>

  <div style="height: 60px;"></div>

  <input type="text" name="username" style="font-family: 'Cormorant Upright'; font-size: 28px;" placeholder="Username" required>
  <input type="password" name="password" style="font-family: 'Cormorant Upright'; font-size: 28px;" placeholder="Password" required>
